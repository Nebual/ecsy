...
export class World {
   ...
   * @param attributes Additional parameters passed to the System's constructor
   */
  registerSystem<T extends System>(System:SystemConstructor<T>, attributes?: {priority?: number, [key: string]: any}): this;
